...
output "nginx_private_ip" {
  description = "Private IP of Nginx reverse proxy"
...
output "backend_public_ips" {
  description = "Public IPs of backend web servers"
  value = {
    for name, mod in module.backend_servers :
    name => mod.public_ip
  }
}
output "backend_private_ips" {
  description = "Private IPs of backend web servers"
  value = {
    for name, mod in module.backend_servers :
    name => mod.private_ip
  }
